...
type Aba = 'visao' | 'inteligencia' | 'leads' | 'clientes' | 'resultados' | 'movimentacoes' | 'acessos' | 'aulas' | 'planos' | 'produtos' | 'comissoes'
