...
export function OperationalManagementPanel() {
  ...
  return <main className="go ger go-consultoria">
    ...
    {proxima && <p className="go-aviso">A entrada de {dinheiro(proxima.valor)} levaria a perda acumulada a {dinheiro(proxima.perdido)}, acima do limite planejado. Nenhum comando é enviado a um robô.</p>}
    <p className="go-aviso">Retornos de referência, não cotações ao vivo. Progressões podem aumentar rapidamente as perdas e não garantem recuperação ou lucro.</p>
  </main>
}
