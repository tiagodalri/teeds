const CACHE='teeds-4c99915dbd6f';
const SHELL=["./","./index.html","./manifest.webmanifest","./pwa-teeds/icon-192.png","./pwa-teeds/icon-512.png","./assets/MonitoramentoPanel.js?v=4c99915dbd6f","./assets/teeds.css?v=4c99915dbd6f","./assets/teeds.js?v=4c99915dbd6f"];
