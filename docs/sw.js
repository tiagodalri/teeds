const CACHE='teeds-2dd2cbf6eadd';
const SHELL=["./","./index.html","./manifest.webmanifest","./pwa-teeds/icon-192.png","./pwa-teeds/icon-512.png","./assets/MonitoramentoPanel.js?v=2dd2cbf6eadd","./assets/teeds.css?v=2dd2cbf6eadd","./assets/teeds.js?v=2dd2cbf6eadd"];
