const CACHE='teeds-ae9b75ff501f';
const SHELL=["./","./index.html","./manifest.webmanifest","./pwa-teeds/icon-192.png","./pwa-teeds/icon-512.png","./assets/MonitoramentoPanel.js?v=ae9b75ff501f","./assets/teeds.css?v=ae9b75ff501f","./assets/teeds.js?v=ae9b75ff501f"];
