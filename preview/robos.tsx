...
function Preview() {
  ...
  return <div className="app workspace-app">
    ...
    <header className="topbar"><div className="workspace-heading"><strong>Robôs</strong><span>Prévia com dados fictícios · nenhuma operação será enviada</span></div><button onClick={() => { aplicarTema(claro ? 'escuro' : 'claro'); setClaro(!claro) }}>Tema {claro ? 'escuro' : 'claro'}</button></header>
